...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    companion object {
        ...
        const val REQUEST_IMAGE_GALLERY: Int = 2
    ...
    override fun onClick(view: View?) {
        when (view?.id) {
            R.id.captureImageFab -> dispatchTakePictureIntent()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        when {
            ...
            requestCode == REQUEST_IMAGE_GALLERY && resultCode == Activity.RESULT_OK -> {
                setViewAndDetect(getSelectedImage(data))
            }
        }
    }

    private fun getSelectedImage(data: Intent?): Bitmap {
    ...
    private fun getCapturedImage(): Bitmap {
        return if (::currentPhotoPath.isInitialized) {
            ...
            // Handle the case when currentPhotoPath is not initialized
            // This can happen when selecting an image from the gallery
            // You might want to implement a fallback or return a default image
            // For now, I'll return an empty bitmap, but you should customize this based on your app's requirements
            Bitmap.createBitmap(1, 1, Bitmap.Config.ARGB_8888)
        }
    }
